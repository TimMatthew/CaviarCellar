...
// Integration secrets (Fondy / NP / SMTP) are optional here so the server boots
// during early phases with only the DB block — they're checked at point-of-use
// by their adapters.
...
if (!parsed.success) {
  // Fail loud and early — a misconfigured server should never start.
